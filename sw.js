/* ============================================================
   ...
   Lần này: v4 -> v5  để đẩy bản vá BỘ THU LỖI (thêm lọc nhiễu Service Worker
   "Failed to update a ServiceWorker for scope") — đổi VER thì máy khách mới
   hiện thanh "Cập nhật ngay" và tải index.html mới.
   ============================================================ */
const VER   = 'v5';
